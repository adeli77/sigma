...
<div class="site-contact">
    ...
    <?php if (Yii::$app->session->hasFlash('contactFormSubmitted')): ?>
        ...
        <div class="alert alert-success">
            Gracias por contactarnos. Responderemos lo mas pronto posible.
        </div>
    ...
    <?php else: ?>
        ...
        <p>
            Si tiene un requerimiento o pregunta, por favor llene el siguiente formulario para contactarnos.
            Gracias
        </p>
